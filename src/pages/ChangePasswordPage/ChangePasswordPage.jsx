  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'grey', height: '100vh'}}>
      ...
      <WrapperContainerLeft>
        <h1>Xin chào</h1>
        <p>Đổi mật khẩu</p>
        <InputForm style={{marginBottom: '10px'}} placeholder="Mật khẩu hiện tại" value={email} onChange={handleOnchangeEmail} />
        <div style={{position: 'relative'}}>
          ...
          <InputForm placeholder='Mật khẩu muốn đổi' type={isShowPassword ? "text" : "password"} 
